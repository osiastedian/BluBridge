            ...
            <div className="col-md-6">
              <main className={`mt-5 card p-5 border-0 rounded-16`}>
                <div className="d-flex justify-content-center align-items-center">
                  <div className="w-100">
                    <span className="font-size-12px font-weight-bold text-primary">FROM</span>
                    <div className="border rounded-8 w-100 p-4 mt-2">
                      { fromConnector }
                    </div>
                  </div>
                  <div className="px-4">
                    <div className="border shadow rounded-8 p-2 d-flex cursor-pointer" onClick={switchConnectors}>
                      <img src="/arrow-right.svg" width="20px"></img>
                    </div>
                  </div>
                  <div className="w-100">
                    <span className="font-size-12px font-weight-bold text-primary">TO</span>
                    <div className="border rounded-8 w-100 p-4 mt-2">  
                      { toConnector }
                    </div>
                  </div>
